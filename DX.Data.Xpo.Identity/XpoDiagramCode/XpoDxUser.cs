...
namespace DX.Data.Xpo.Identity.Persistent
{
  ...
  //      [NonPersistent]
        ...
        public IList TokenList { get { return Tokens; } }
		...
		// Created/Updated: DEV-RIG-DON\don on DEV-RIG-DON at 10-1-2024 14:23
		public new class FieldsClass : XpoDxBase.FieldsClass
		{
			...
			public const string TokenListFieldName = "TokenList";

			public OperandProperty TokenList => new OperandProperty(GetNestedName(TokenListFieldName));
			...
			public const string ConcurrencyStampFieldName = "ConcurrencyStamp";

			public OperandProperty ConcurrencyStamp => new OperandProperty(GetNestedName(ConcurrencyStampFieldName));
